...
export declare class OrdersController {
    ...
    myOrders(userId: string, query: OrderQueryDto): Promise<import("../../common/dto/pagination.dto").PaginatedResult<{
        user: {
            id: string;
            email: string;
            fullName: string;
    ...
    myOrder(userId: string, id: string): Promise<{
        user: {
            id: string;
            email: string;
            phone: string;
    ...
    cancelMy(userId: string, id: string): Promise<{
        id: string;
        createdAt: Date;
        updatedAt: Date;
        status: import(".prisma/client").$Enums.OrderStatus;
