...
let UsersController = class UsersController {
    ...
    updateProfile(id, body) { return this.usersService.updateProfile(id, body); }
    getAddresses(id) { return this.usersService.getAddresses(id); }
    addAddress(id, body) { return this.usersService.addAddress(id, body); }
    removeAddress(id, addrId) { return this.usersService.removeAddress(id, addrId); }
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Get my addresses' }),
    openapi.ApiResponse({ status: 200 }),
    __param(0, (0, current_user_decorator_1.CurrentUser)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
...
__decorate([
    (0, common_1.Delete)('me/addresses/:addrId'),
    (0, swagger_1.ApiOperation)({ summary: 'Delete address' }),
    openapi.ApiResponse({ status: 200 }),
    __param(0, (0, current_user_decorator_1.CurrentUser)('id')),
    __param(1, (0, common_1.Param)('addrId')),
    __metadata("design:type", Function),
